...
**Napi 是一款 AI 模型路由工具,能够最大化你的订阅价值并最小化成本。**
...
**破坏性变更:**
- 查看 [CHANGELOG.md](https://github.com/decolua/napi/blob/main/CHANGELOG.md)
- 大版本更新前备份 `~/.napi`
- 阅读大版本的迁移指南
...
详情见 [CONTRIBUTING.md](https://github.com/decolua/napi/blob/main/CONTRIBUTING.md)。

---

## 需要更多帮助?

- **文档:** [napi.com/docs](https://napi.com/docs)
