...
Hướng dẫn cài đặt chi tiết cho Napi với mẹo troubleshooting.
...
Cài Napi toàn cục để dùng ở bất kỳ đâu:
...
- ✅ Chạy từ mọi thư mục
- ✅ Lệnh đơn giản: `napi`
- ✅ Auto-update với `npm update -g napi`
...
**Điều gì xảy ra:**
1. Server khởi động tại `http://localhost:20000`
2. Dashboard tự động mở trong browser
3. Data directory được tạo tại `~/.napi`
...
**Vấn đề:** Napi dùng quá nhiều RAM
