...
Khởi chạy Napi trong 5 phút và bắt đầu định tuyến các request AI một cách thông minh.
...
🎉 **Dashboard tự động mở** tại `http://localhost:20000`
...
Trỏ công cụ code của bạn tới Napi:
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [from napi dashboard]
