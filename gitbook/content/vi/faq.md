...
Những câu hỏi phổ biến về Napi.

---

## Napi là gì?

**Napi là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**Napi dùng chiến lược pricing 3 tầng:**
...
## Napi có miễn phí không?

**Có, Napi hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của Napi.**
...
**Napi theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host Napi không?

**Có! Napi hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.napi`)
...
**Có, Napi ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.napi` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server Napi
...
**Breaking changes:**
- Xem [CHANGELOG.md](https://github.com/decolua/napi/blob/main/CHANGELOG.md)
- Backup `~/.napi` trước khi update lớn
...
Xem [CONTRIBUTING.md](https://github.com/decolua/napi/blob/main/CONTRIBUTING.md) để biết chi tiết.

---

## Cần trợ giúp thêm?

- **Documentation:** [napi.com/docs](https://napi.com/docs)
