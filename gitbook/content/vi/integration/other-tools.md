...
Napi tương thích với mọi công cụ hỗ trợ format API OpenAI. Hướng dẫn này bao gồm pattern tích hợp tổng quát cho nhiều công cụ và ứng dụng tùy chỉnh.

## Tổng quan

Napi cung cấp API endpoint tương thích OpenAI hoạt động với:
...
Mọi công cụ tương thích OpenAI có thể kết nối đến Napi bằng các cài đặt sau:

**Napi cục bộ:**
```
Base URL: http://localhost:20000/v1
API Key: your-api-key-from-dashboard
Model: any Napi model (cc/*, cx/*, glm/*, etc.)
```
...
**Vấn đề:** Không kết nối được đến Napi
```bash
# Check if Napi is running
...
**Giải pháp:**
- Xác minh Napi đang chạy
- Kiểm tra port 20000 không bị chặn
...
- Kiểm tra model có sẵn: `curl http://localhost:20000/v1/models`
...
- Kiểm tra kết nối network đến Napi
