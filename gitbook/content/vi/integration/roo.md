...
Tích hợp Napi với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
### Connection Failed
- Xác minh Napi đang chạy: `curl http://localhost:20000/health`
