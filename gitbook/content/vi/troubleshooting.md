...
Các vấn đề và giải pháp phổ biến khi dùng Napi.
...
1. **Auto-refresh (mặc định):**
   Napi tự refresh tokens. Đợi 30 giây rồi thử lại.
...
**Vấn đề:** Lỗi "ECONNREFUSED" hoặc "Cannot connect to localhost:20000".
