...
Triển khai Napi trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
| `DATA_DIR` | `~/.napi` | Đường dẫn lưu database và data |
...
Tạo `/etc/nginx/sites-available/napi`:
...
# If NOT using reverse proxy, allow Napi ports
