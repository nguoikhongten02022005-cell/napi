...
Common issues and solutions when using Napi.
...
1. **Auto-refresh (default):**
   Napi automatically refreshes tokens. Wait 30 seconds and retry.
...
**Problem:** "ECONNREFUSED" or "Cannot connect to localhost:20000".
