...
Integrate Napi with OpenAI Codex CLI to route your OpenAI API requests through Napi's intelligent routing system.
...
Napi provides the following Codex models:
...
1. Verify your API key is correct in Napi dashboard
...
1. Verify the model name matches your Napi configuration
2. Check that the OpenAI provider connection is active in Napi dashboard
...
Make sure you have configured your API key in the Napi cloud dashboard.
