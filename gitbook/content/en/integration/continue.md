...
Integrate Napi with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- Napi API key from [dashboard](https://napi.com/dashboard)
- Napi running (local or cloud)
...
### 2. Add Napi Model Configuration
...
3. Choose your preferred Napi model
