...
Integrate Napi with Claude Code CLI to route your Anthropic API requests through Napi's intelligent routing system.
...
Claude Code supports the following model aliases that map to Napi models:
