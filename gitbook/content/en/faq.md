...
Common questions about Napi.

---

## What is Napi?

**Napi is an AI model router that maximizes your subscription value and minimizes costs.**
...
**Napi uses a 3-tier pricing strategy:**
...
**Yes, Napi itself is 100% free and open source.**
...
**Yes! This is Napi's core feature.**
...
**Napi tracks quota in real-time for all providers:**
...
## Can I self-host Napi?

**Yes! Napi supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.napi`)
...
**Yes, Napi prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.napi` (or custom `DATA_DIR`)
- No data sent to Napi servers
...
**Breaking changes:**
- Check [CHANGELOG.md](https://github.com/decolua/napi/blob/main/CHANGELOG.md)
- Backup `~/.napi` before major updates
...
See [CONTRIBUTING.md](https://github.com/decolua/napi/blob/main/CONTRIBUTING.md) for details.
