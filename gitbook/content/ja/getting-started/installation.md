...
トラブルシューティングのヒント付きのNapi詳細インストールガイド。
...
どこからでも使用できるようにNapiをグローバルインストール:
...
**何が起こるか:**
1. サーバーが `http://localhost:20000` で起動
2. ダッシュボードが自動的にブラウザで開く
3. `~/.napi` にデータディレクトリが作成される
4. APIキーが自動生成される
