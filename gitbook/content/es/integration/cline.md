...
Integra Napi con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de Napi.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Cline instalada desde el marketplace de VSCode
- Napi ejecutándose localmente o endpoint en la nube configurado
...
Establece la URL base a tu endpoint de Napi:
...
**Para Napi en la nube:**
```
https://napi.com
```

**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de Napi
...
```
API Provider: Ollama
Base URL: http://localhost:20000/v1
...
4. Cline usará Napi para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando Napi
...
3. Obtén explicaciones potenciadas por IA a través de Napi

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará Napi para entender el contexto y hacer cambios
...
1. Verifica que Napi esté corriendo: `curl http://localhost:20000/health`
2. Verifica que la URL base sea correcta e incluya `/v1`
3. Asegúrate de que ningún firewall esté bloqueando el puerto 20000
...
2. Verifica que tu instancia de Napi esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de Napi para cualquier error

## Configuración avanzada

### Usar endpoint en la nube

Para usar el endpoint en la nube de Napi en lugar de localhost:

1. En la configuración de Cline, establece Base URL a: `https://napi.com`
2. Asegúrate de haber configurado tu API key en el dashboard en la nube de Napi
...
## Integración con características de Napi

### Enrutamiento de modelos

Napi enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, Napi automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de Napi:
