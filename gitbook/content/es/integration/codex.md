...
Integra Napi con OpenAI Codex CLI para enrutar tus solicitudes de la API de OpenAI a través del sistema de enrutamiento inteligente de Napi.
...
```bash
# Base URL for Napi
export OPENAI_BASE_URL="http://localhost:20000/v1"

# API Key from Napi dashboard
export OPENAI_API_KEY="your-napi-api-key"
```
...
Napi proporciona los siguientes modelos de Codex:
...
```json
{
  "baseUrl": "http://localhost:20000/v1",
  "apiKey": "your-napi-api-key",
...
1. Verifica que tu API key sea correcta en el dashboard de Napi
...
1. Verifica que el nombre del modelo coincida con tu configuración de Napi
2. Verifica que la conexión del proveedor de OpenAI esté activa en el dashboard de Napi
...
```bash
export OPENAI_BASE_URL="https://napi.com"
```

Asegúrate de haber configurado tu API key en el dashboard en la nube de Napi.
