...
Integra Napi con Claude Code CLI para enrutar tus solicitudes de la API de Anthropic a través del sistema de enrutamiento inteligente de Napi.
...
```bash
# Base URL for Napi
export ANTHROPIC_BASE_URL="http://localhost:20000/v1"
...
Claude Code soporta los siguientes aliases de modelos que mapean a modelos de Napi:
...
```bash
export ANTHROPIC_BASE_URL="https://napi.com"
```
