...
Napi es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

Napi proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a Napi usando estas configuraciones:

**Napi local:**
```
Base URL: http://localhost:20000/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de Napi (cc/*, cx/*, glm/*, etc.)
```

**Napi en la nube:**
```
Base URL: https://napi.com/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de Napi (cc/*, cx/*, glm/*, etc.)
```
...
**Solicitud:**
```
POST http://localhost:20000/v1/chat/completions
```
...
llm = OpenAI(
    model="cc/claude-sonnet-4-20250514",
    api_key="your-api-key-from-dashboard",
    api_base="http://localhost:20000/v1"
)
...
openai.api_base = "http://localhost:20000/v1"
...
ROUTER_BASE_URL=http://localhost:20000/v1
...
**Problema:** No se puede conectar a Napi
```bash
# Verifica si Napi está corriendo
...
**Solución:**
- Verifica que Napi esté corriendo
- Verifica que el puerto 20000 no esté bloqueado
...
- Verifica los modelos disponibles: `curl http://localhost:20000/v1/models`
...
- Verifica la conexión de red a Napi
