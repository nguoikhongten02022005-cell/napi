...
Problemas comunes y soluciones al usar Napi.
...
1. **Refresh automático (por defecto):**
   Napi refresca automáticamente los tokens. Espera 30 segundos y reintenta.
...
**Problema:** "ECONNREFUSED" o "Cannot connect to localhost:20000".

**Causas:**
- Napi no está ejecutándose
- Puerto 20000 bloqueado
...
1. **Verifica si Napi está ejecutándose:**
   ```bash
   # Verifica el proceso
   ps aux | grep napi
...
- **GitHub Issues:** [github.com/decolua/napi/issues](https://github.com/decolua/napi/issues)
