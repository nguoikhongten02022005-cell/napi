...
Guía detallada de instalación de Napi con consejos de solución de problemas.
...
Instala Napi globalmente para usar desde cualquier lugar:
...
- ✅ Comando simple: `napi`
- ✅ Auto-actualizaciones con `npm update -g napi`
...
**Qué sucede:**
1. El servidor inicia en `http://localhost:20000`
2. El dashboard se abre automáticamente en el navegador
3. Se crea el directorio de datos en `~/.napi`
...
```bash
# Encuentra proceso usando el puerto 20000
lsof -i :20000
...
**Problema:** Napi usa demasiada RAM
...
nano ~/.bashrc  # o ~/.zshrc
# Eliminar exports relacionados con napi
```
