...
Pon en marcha Napi en 5 minutos y comienza a enrutar solicitudes de IA de forma inteligente.
...
🎉 **El dashboard se abre automáticamente** en `http://localhost:20000`
...
Apunta tu herramienta de codificación a Napi:
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [desde el dashboard de napi]
...
- **Sitio web**: [napi.com](https://napi.com)
