...
Preguntas comunes sobre Napi.

---

## ¿Qué es Napi?

**Napi es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**Napi usa una estrategia de precios de 3 niveles:**
...
**Sí, Napi en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de Napi.**
...
**Napi rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿Napi funciona con Cursor?

**Sí, pero Cursor requiere un endpoint en la nube.**

**Problema:** Cursor IDE no soporta endpoints en localhost.

**Solución:** Usa el despliegue en la nube de Napi:

```
Cursor Settings → Models → Advanced:
  OpenAI API Base URL: https://napi.com/v1
...
## ¿Puedo auto-hospedar Napi?

**¡Sí! Napi soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.napi`)
...
**Sí, Napi prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.napi` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de Napi
...
**Cambios disruptivos:**
- Revisa [CHANGELOG.md](https://github.com/decolua/napi/blob/main/CHANGELOG.md)
- Respalda `~/.napi` antes de actualizaciones mayores
...
1. **Reportar bugs:**
   - [GitHub Issues](https://github.com/decolua/napi/issues)
   - Incluye logs de error, pasos para reproducir

2. **Solicitar características:**
   - [GitHub Discussions](https://github.com/decolua/napi/discussions)
...
Consulta [CONTRIBUTING.md](https://github.com/decolua/napi/blob/main/CONTRIBUTING.md) para detalles.

---

## ¿Necesitas más ayuda?

- **Documentación:** [napi.com/docs](https://napi.com/docs)
