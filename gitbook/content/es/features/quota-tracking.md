...
Napi proporciona un seguimiento de cuota integral para todos los proveedores:
...
```bash
GET http://localhost:20000/api/quota
...
```bash
GET http://localhost:20000/api/usage?period=today
Authorization: Bearer your-api-key
...
4. Reinicia Napi si el problema persiste
