...
const CLI_TOKEN_HEADER = "x-napi-cli-token";
const CLI_TOKEN_SALT = "napi-cli-auth";
const APP_NAME = "napi";
 ...
 * @returns {Promise<Object>} { success, data: { installed, hasNapi, ... } }
 */
