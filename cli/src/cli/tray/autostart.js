...
const APP_NAME = "napi";
const APP_LABEL = "com.napi.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when napi is currently
 ...
 * SIGTERM to the running process. When the running napi cli.js was itself
...
<dict>
    ...
    <string>/tmp/napi.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/napi.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `napi.cmd` lookup that depended on the npm prefix path.
