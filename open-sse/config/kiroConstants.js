 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what napi needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a napi
...
/**
 * Detect whether a model id refers to a napi synthetic agentic variant.
...
/**
 * Detect whether a model id is a napi synthetic thinking variant
...
/**
 * Resolve a napi model id to the real upstream Kiro model id, plus flags
