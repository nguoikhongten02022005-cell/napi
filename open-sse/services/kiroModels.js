 ...
 * API. They are napi fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic napi variant set for a single upstream Kiro model.
 *
 ...
 * into napi variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
