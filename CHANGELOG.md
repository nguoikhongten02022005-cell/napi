...
- Docker images now published on both Docker Hub (`decolua/napi`) and GHCR — pull from your preferred registry
...
## Fixes
- DATA_DIR: graceful fallback to ~/.napi on EACCES/EPERM (#1005)
...
## Docs
- Add Chinese translation docs (#957)
- Fix localized docs links (#956)
...
## Features
- Speech-to-Text: full pipeline with sttCore + /v1/audio/transcriptions; configs for OpenAI, Gemini, Groq, Deepgram, AssemblyAI, HuggingFace, NVIDIA Parakeet; new napi-stt skill
...
## Fixes
- Fix skills metadata/text in napi, chat, embeddings, image, tts, web-fetch, web-search SKILL.md and skills page
...
- Redirect ~/.napi to DATA_DIR in Docker (persist usage across updates)
