...
// Build TOML config for Napi (openai provider mode)
const buildNapiConfig = (baseUrl, apiKey, model) => {
...
// Detect Napi by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildNapiConfig(baseUrl, apiKey || "sk_napi", model);
