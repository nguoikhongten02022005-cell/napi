...
export const GITHUB_CONFIG = {
  changelogUrl: "https://raw.githubusercontent.com/decolua/napi/refs/heads/master/CHANGELOG.md",
  donateUrl: "https://napi.com/api/donate",
};

// Updater configuration
export const UPDATER_CONFIG = {
  npmPackageName: "napi",
  installCmd: "npm i -g napi",
  installCmdLatest: "npm i -g napi@latest --prefer-online",
